...
const select_project_dto_1 = require("../../application/dto/select-project.dto");
let ProjectController = class ProjectController {
    projectService;
    constructor(projectService) {
        this.projectService = projectService;
    }
    async selectProject(dto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [select_project_dto_1.SelectProjectDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getFileTree", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getFileContent", null);
